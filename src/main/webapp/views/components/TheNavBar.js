        ...
        let view =  /*html*/`
                <nav class="flex items-center justify-between flex-wrap bg-white-500">
                    ...
                    <div class="flex justify-center">
                        ...
                        <button id="sign-out-btn" class="flex flex-row items-center justify-center bg-lightblue border border-lightblue hover:border-blue text-blue py-2 px-4 rounded-full focus:outline-none">
                        Sign Out 
                        </button>
                    </div>
                </nav>
