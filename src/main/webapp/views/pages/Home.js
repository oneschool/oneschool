...
const Home = {
    render : async () => {
        ...
        const view =  /*html*/`
            ...
            <div x-data="{ openHomeSideBar: false }" class="relative pt-6 pb-16 md:pb-20 lg:pb-24 xl:pb-32">
              <nav class="relative max-w-screen-xl mx-auto flex items-center justify-between px-4 sm:px-6">
                ...
                <div id="sign-in-btn" style="display: none;" class="md:block text-right">
                ...
                <div id="sign-out-btn" style="display: none;" class="md:block text-right">
                    <span class="inline-flex rounded-md shadow-md">
                    <span class="inline-flex rounded-md shadow-xs">
                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                  <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    ...
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      OneSchool is a platform inspired by the way we learn. From schools to colleges to tuition teachers, you teach however you like at the ease of our product.
                    </p>
